	...
	factory: (require) => {
		...
		*/
		...
		const styles = {
			...
			detailRow: { background: "var(--dsw-alias-bg-layer-0)" },
			detailCell: {
				padding: "16px",
				borderBottom: "1px solid var(--dsw-alias-border-l1)"
			},
		...
		function SkillMcpManagerPanel(props) {
			...
			const [togglingAll, setTogglingAll] = (0, react.useState)(null);
			const [expandedSkills, setExpandedSkills] = (0, react.useState)(/* @__PURE__ */ new Set());
			...
			const handleAddSkill = async () => {
				...
				if (name === "" && skillForm.sourceFile === null) {
					setSkillActionNote({
						ok: false,
						text: "Give the skill a name, or upload a .md file to derive one."
					});
					return;
				}
			...
			const handlePickSkillFile = async (file) => {
				...
				setSkillActionNote(null);
				const preview = await props.previewSkillUpload({
					name: file.name,
					content
				});
				if (preview.ok) {
					...
					setSkillForm((current) => ({
						...
						whenToUse: current.whenToUse.trim() !== "" && p.whenToUse !== void 0 ? current.whenToUse : p.whenToUse ?? "",
						modelInvocable: p.modelInvocable,
						userInvocable: p.userInvocable
					}));
				} else setSkillActionNote({
					ok: false,
					text: `Could not read the file's metadata: ${preview.error}`
				});
			};
			...
			const handleToggleAll = async (field, value) => {
				...
				for (const skill of skills.skills) {
					...
					if (outcome.ok) {
						if (!outcome.value.ok) {
							setSkillActionNote({
								ok: false,
								text: `Could not update ${skill.name}: ${outcome.value.error}`
							});
							setTogglingAll(null);
							refreshSkills();
							return;
						...
						setSkillActionNote({
							ok: false,
							text: `Could not update ${skill.name}: ${outcome.error}`
						});
						setTogglingAll(null);
						refreshSkills();
						return;
				...
				setSkillActionNote({
					ok: true,
					text: `Set ${field === "model" ? "model" : "user"} visibility ${value ? "on" : "off"} for all skills.`
				});
				setTogglingAll(null);
				refreshSkills();
			};
					...
					tab === "skills" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								skills.skills.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
												...
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													style: styles.thStack,
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "Show to model" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
														type: "button",
														style: styles.toggleAllButton,
														disabled: togglingAll !== null,
														onClick: () => void handleToggleAll("model", !allModelShown),
														children: allModelShown ? "Hide all" : "Show all"
													})]
												})
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
												...
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													style: styles.thStack,
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "Show to user" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
														type: "button",
														style: styles.toggleAllButton,
														disabled: togglingAll !== null,
														onClick: () => void handleToggleAll("user", !allUserShown),
														children: allUserShown ? "Hide all" : "Show all"
													})]
												})
											})
										] }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: skills.skills.map((skill) => {
											const isOpen = expandedSkills.has(skill.path);
											return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", {
											...
											}), isOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tr", {
												...
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("td", {
													...
													children: [
														...
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
															...
															children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.MarkdownText, { text: skill.markdown })
														}),
														/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
															...
															children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
																...
																children: "View full SKILL.md source"
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											children: "Upload skill markdown"
										}),
								...
								skillForm.sourceFile !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
									style: styles.notice,
									children: [
										"Fields were pre-filled from the file's frontmatter (title, description,\xA0",
										`whenToUse`,
										", visibility) — edit any of them before adding. The file's body and any custom frontmatter keys are kept as-is."
									]
								}) : null,
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
									style: styles.fieldLabel,
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
										...
										children: [
											mcp.live.length,
											" connections · ",
											mcp.live.reduce((count, server) => count + server.children.length, 0),
											" gateway servers. Changes apply automatically. Expand a connection to review its tools."
										]
									}),
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [
														...
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
															style: styles.badge,
															children: server.managed ? "managed" : "external"
														}),
												...
												}), server.managed ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
													type: "button",
													style: {
														...styles.dangerButton,
													...
													style: styles.hint,
													children: "Managed outside this panel"
												})]
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
												style: { marginTop: "8px" },
												children: [
													...
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
														...
														children: server.tools.map((tool) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: tool }, tool))
													}),
													server.tools.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
														style: styles.hint,
														children: "No tools are registered for this connection."
													}) : null
												]
											}),
											server.children.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												style: {
													display: "flex",
													flexDirection: "column",
													gap: "8px",
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
													style: styles.itemTitle,
													children: "Servers in this gateway"
												}), server.children.map((child) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
													style: styles.item,
													children: [
														/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("summary", {
															style: {
															...
															children: [
																...
																/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
																	style: styles.badge,
																	children: child.availableTools.length > 0 ? `${child.availableTools.length} tools available` : "No tools detected"
																}),
																/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
																	style: styles.hint,
														...
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
															style: styles.hint,
															children: "Managed through the Docker gateway profile."
														}),
														child.availableTools.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
															style: styles.hint,
															children: "This server is configured, but no matching tools are registered. It may be filtered, unavailable, or waiting to start."
														}) : null,
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
															style: {
																...styles.caption,
															...
															children: child.tools.map((tool) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", { children: [tool, child.availableTools.includes(tool) ? "" : " · not detected"] }, tool))
														})
													]
												}, child.name))]
											}) : null
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
										...
										children: [mcpDraft.transport === "stdio" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
												style: styles.fieldLabel,
		...
		function parseSkillView(value) {
			...
			if (!isString(markdown) || !isString(source) || !isString(name) || !isString(description) || !isString(root) || !isString(rootLabel) || !isString(path) || kind !== "bundle" && kind !== "flat" || !isBoolean(modelInvocable) || !isBoolean(userInvocable)) throw new TypeError("skill has invalid fields");
			return {
				name,
				description,
				markdown,
		...
		function parseMcpChildren(value) {
			if (!Array.isArray(value)) throw new TypeError("MCP children must be an array");
			return value.map((child) => {
				if (!isRecord(child) || !isString(child.name) || !isString(child.description) || !isStringArray(child.tools) || !isStringArray(child.availableTools)) throw new TypeError("Invalid MCP child server");
				return {
					name: child.name,
					description: child.description,
					tools: child.tools,
					availableTools: child.availableTools
				};
			});
		}
		...
		function parseSourceMarkdownFile(value) {
			if (!isRecord(value) || !isString(value.name) || !isString(value.content)) throw new TypeError("source file must be an object with string name and content");
			return {
				name: value.name,
				content: value.content
			};
		}
		function parseSkillUploadPreview(value) {
			if (!isRecord(value) || !isString(value.name) || !isString(value.description) || !isBoolean(value.modelInvocable) || !isBoolean(value.userInvocable)) throw new TypeError("upload preview must have string name/description and two booleans");
			const preview = {
				name: value.name,
		...
		function parseAddSkillInput(value) {
			...
			if (sourceFile !== void 0) optional.sourceFile = parseSourceMarkdownFile(sourceFile);
			return {
				name,
				description,
				body,
		...
		const SKILL_UPLOAD_PREVIEW_SCHEMA = { parse: parseSkillUploadPreview };
		...
		const DESCRIPTORS = [
			...
			descriptor("previewSkillUpload", [{
				...
				codec: {
					mode: "strict",
					typeSymbol: "dsh-skill-mcp-manager#SourceMarkdownFile",
					schema: { parse: parseSourceMarkdownFile }
				}
